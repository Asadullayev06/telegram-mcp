...
ENV AUTO_REPLY_LLM_BASE_URL="https://api.groq.com/openai/v1"
ENV AUTO_REPLY_LLM_MODEL="llama-3.3-70b-versatile"
ENV AUTO_REPLY_LLM_MAX_TOKENS="300"
ENV AUTO_REPLY_LLM_TEMPERATURE="0.8"
ENV AUTO_REPLY_HISTORY_LIMIT="20"
ENV AUTO_REPLY_READ_DELAY="10.0"
ENV AUTO_REPLY_TYPING_DELAY="4.0"
